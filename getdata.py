...
# Call
# python3 getdata.py --name my_dataset \
#                 --path https://storage.googleapis.com/neuroglancer-public-data/kasthuri2011/image_color_corrected \
#                 --train \
#                 --image_size 128 \
#                 --denoise \
#                 --coord_list_path ./coords.json \
#                 --n_vols 1
